...
<div class="prosuct-wrap">
            ...
            <div class="container padd-lr0 xs-padd">
                <div class="product-list clearfix" style="padding: 0">
                            ...
                            <div class="product-table">
                                <div class="img-wrap product-cell">
                                    ...
                                    <div class="text-wrap product-cell">
                                        <div class="title">{{$car->categories->marque}} {{$car->model}}</div>
                                            
                                    </div>
                                
                                <div class="price-wrap product-cell">
                                    <span>${{$car->prix}}</span><sup>00</sup>/Day
                                </div>
                                <div class="col-md-6 padd-lr0">
                                    <form action="{{route('handleVerificationBooking', ['car_id'=>$car->id, 'dateDepart'=>$dateDepart, 'dateRetour'=>$dateRetour])}}" method="GET">
